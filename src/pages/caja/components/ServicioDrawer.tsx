...
export function ServicioDrawer({ isOpen, onClose, onSuccess, servicioEnEdicion }: ServicioDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] !m-0">
      ...
      <div className="absolute right-0 inset-y-0 w-full md:w-[460px] lg:max-w-lg bg-white shadow-2xl z-[10000] transform transition-transform duration-300 flex flex-col animate-in slide-in-from-right">
        {/* Header */}
