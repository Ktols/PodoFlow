  ...
  return (
    <>
      ...
      <div className="bg-white rounded-2xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-gray-100 p-4 md:p-5 flex flex-col md:flex-row gap-4 items-center justify-between mb-6">
        ...
        <button
          onClick={handleNew}
          className="w-full md:w-auto bg-[#00C288] hover:bg-[#00ab78] text-white px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 font-black tracking-wide shadow-md transition-all hover:-translate-y-0.5"
        >
